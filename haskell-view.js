...
var _user$project$Main$showName = function (hsType) {
	return A2(_elm_lang$core$Basics_ops['++'], 'name: ', hsType.name);
};
var _user$project$Main$viewLine = function (line) {
	return A2(
...
var _user$project$Main$initialModel = {
	json: _elm_lang$core$Native_List.fromArray(
		[
			{
			name: 'a',
			from: {line: 0, col: 2},
...
var _user$project$Main$HsType = F3(
	function (a, b, c) {
		return {name: a, from: b, to: c};
	});
